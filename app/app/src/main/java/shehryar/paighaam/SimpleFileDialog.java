...
public class SimpleFileDialog {
    ...
    SimpleFileDialog(Context context, String file_select_type, SimpleFileDialogListener SimpleFileDialogListener) {
    ...
    private AlertDialog.Builder createDirectoryChooserDialog(String title, List<String> listItems,
        ...
        if (Select_type == FileOpen) m_titleView1.setText(String.valueOf("Open"));
        if (Select_type == FileSave) m_titleView1.setText(String.valueOf("Save As"));
        if (Select_type == FolderChoose) m_titleView1.setText(String.valueOf("Folder Select"));
        ...
        if (Select_type == FolderChoose || Select_type == FileSave) {
            ...
            newDirButton.setText(String.valueOf("New Folder"));
